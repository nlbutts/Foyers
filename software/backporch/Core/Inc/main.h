...
#define VIN_MEASURE_Pin GPIO_PIN_0
...
#define TB_TIMA_GPIO_Port GPIOB
#define TB_TIMB_Pin GPIO_PIN_1
#define TB_TIMB_GPIO_Port GPIOB
#define LED2_Pin GPIO_PIN_2
#define LED2_GPIO_Port GPIOB
#define TB_ENCI_Pin GPIO_PIN_8
#define TB_ENCI_GPIO_Port GPIOA
#define LED1_Pin GPIO_PIN_6
#define LED1_GPIO_Port GPIOC
#define CAN_STATUS_Pin GPIO_PIN_5
