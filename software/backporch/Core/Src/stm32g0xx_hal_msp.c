...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = VIN_MEASURE_Pin|CURRENT_5V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOA, VIN_MEASURE_Pin|CURRENT_5V_Pin);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  */
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = TB_ENCI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
    HAL_GPIO_Init(TB_ENCI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  if(htim_base->Instance==TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = TB_TIMA_Pin|TB_TIMB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  if(htim_ic->Instance==TIM1)
  {
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(TB_ENCI_GPIO_Port, TB_ENCI_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(GPIOB, TB_TIMA_Pin|TB_TIMB_Pin);
